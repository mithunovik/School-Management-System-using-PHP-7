...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="col mb-4 mt-4">
        <h3 class="bg-dark text-center" style="color: white; font-family: Palatino Linotype;">Classic</h3>
    </div>
<div class="container">
    <div class="row">
        <div class="col">
  ...
  <div class="card">
    ...
    <div class="card-body">
      <h5 class="card-title">Lorna Doone (1869)</h5>
      <p class="card-text">Because this is no sickly sweet romance. Holy cow, those Doones are wicked people and Lorna's caught in the middle..</p>
    </div>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <h5 class="card-title">Jamaica Inn (1936)</h5>
      <p class="card-text">Because it’s another wonderful stuck–in–the–middle tale. Twenty–year–old Mary Yellan is surrounded by murderous Cornish wreckers.</p>
    </div>
    <div class="card-footer">
    <a type="button" class="btn btn-primary" href="#">Rent</a>
    </div>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <h5 class="card-title">Kidnapped (1886)</h5>
      <p class="card-text">Because it’s better than Treasure Island and based on real people and real events. Alan Breck Stewart is a memorable character..</p>
    </div>
    <div class="card-footer">
    <a type="button" class="btn btn-primary" href="#">Rent</a>
    </div>
...
<div class="card-deck mt-4">
  <div class="card">
    ...
    <div class="card-body">
      <h5 class="card-title">Treasure Island (1883)</h5>
      <p class="card-text">Because I like to imagine hosting a dinner party featuring Long John Silver, Blind Pew, Ben Gunn and Billy Bones. More rum, more fun.</p>
    </div>
    <div class="card-footer">
  ...
  <div class="card">
    ...
    <div class="card-body">
      <h5 class="card-title">A Tale of Two Cities (1859)</h5>
      <p class="card-text">Because Dickens showed he could write magnificent historical fiction with this dramatic story of the French Revolution..</p>
    </div>
    <div class="card-footer">
    <a type="button" class="btn btn-primary" href="#">Rent</a>
    </div>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <h5 class="card-title">Oliver Twist (1838)</h5>
      <p class="card-text">Because it was no picnic being a child on the street in Victorian London. My favorite piece of Dickensian literature.</p>
    </div>
    <div class="card-footer">
    <a type="button" class="btn btn-primary" href="#">Rent</a>
    </div>
