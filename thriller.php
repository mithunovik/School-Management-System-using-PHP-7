...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="col mb-4 mt-4">
        <h3 class="bg-dark text-center" style="color: white; font-family: Palatino Linotype;">Thriller</h3>
    </div>
<div class="container">
    <div class="row">
        <div class="col">
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <p class="card-text">If Gillian Flynn is the queen of modern suspense, Ruth Ware is the knight presiding over the Round Table. Oft likened to a modern-day Agatha Christie, Ware excels at thrillers set within the confines of close.</p>
    </div>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <h5 class="card-title">The Woman in Cabin</h5>
      <p class="card-text">Megan Abbott’s name may not be as widely known as that of Gillian Flynn, but she is equally as essential a writer for fans of suspense and thriller fiction, and You Will Know Me showcases the author at her best.</p>
    </div>
    <div class="card-footer">
    <a type="button" class="btn btn-primary" href="#">Rent</a>
    </div>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <h5 class="card-title">Your House Will Pay</h5>
      <p class="card-text">We’ve featured this novel before, because it’s just that good: An urgent (and suddenly timely) examination of racial tensions in Los Angeles, Steph Cha’s latest is a page.</p>
    </div>
    <div class="card-footer">
    <a type="button" class="btn btn-primary" href="#">Rent</a>
    </div>
...
<div class="card-deck mt-4">
  <div class="card">
    ...
    <div class="card-body">
      <h5 class="card-title">You, Volume 1</h5>
      <p class="card-text">We all owe Caroline Kepnes a debt for penning the source material that gave us Penn Badgley’s terrifying performance as Joe Goldberg on the hit Netflix serial-killer show You.</p>
    </div>
    <div class="card-footer">
  ...
  <div class="card">
    ...
    <div class="card-body">
      <h5 class="card-title">The Talented Mr. Ripley</h5>
      <p class="card-text">God is a woman, but make it “the original master of the psychological thriller.” Though Patricia Highsmith may be best known today as the author of the classic lesbian romance Carol.</p>
    </div>
    <div class="card-footer">
    <a type="button" class="btn btn-primary" href="#">Rent</a>
    </div>
  ...
  <div class="card">
    <img class="card-img-top" src="t6.jpg" alt="Card image cap">
    <div class="card-body">
      <h5 class="card-title">Black Water Rising </h5>
      <p class="card-text">You already know Attica Locke’s work, whether or not you realize it: The author is also an accomplished screenwriter who counts Empire, When They See Us, </p>
    </div>
    <div class="card-footer">
    <a type="button" class="btn btn-primary" href="#">Rent</a>
    </div>
