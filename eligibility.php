...
<body style="background-color: rgb(221, 239, 255)">
    ...
    <div class="eligibility">
          <h1 class="eli_h">Eligibility</h1>
          <p class="eli_p">
            <b>Our general eligibility requirements are that you must-</b>
            <ul>
                <li>-demonstrate financial need (for extra curriculam programs);</li>
                <li>-be a Bangladeshi citizen;</li>
                <li>-have a valid Social Security number;</li>
                <li>-be registered with Selective Service;</li>
                <li>-be enrolled or accepted for enrollment as a regular student in an eligible or certificate program;</li>
                <li>-be enrolled at least half-time to be eligible for Direct Loan Program funds;</li>
                <li>-maintain satisfactory academic progress in career school.</li>
            </ul>        
          </p>                   
    </div>
