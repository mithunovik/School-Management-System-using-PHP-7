...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="col mb-4 mt-4">
        <h3 class="bg-dark text-center" style="color: white; font-family: Palatino Linotype;">Novel</h3>
    </div>
<div class="container">
    <div class="row">
        <div class="col">
    <div class="card-deck">
  <div class="card">
    <img class="card-img-top" src="n1.jpeg" alt="Card image cap">
    <div class="card-body">
      <h5 class="card-title">The Girl Without A Name</h5>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <h5 class="card-title">The Runner</h5>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <h5 class="card-title">The Guest List</h5>
...
<div class="card-deck mt-4">
  <div class="card">
    ...
    <div class="card-body">
      <h5 class="card-title">The Ocean At The End Of The Land</h5>
      <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
    </div>
    <div class="card-footer">
  ...
  <div class="card">
    ...
    <div class="card-body">
      <h5 class="card-title">The Lord Of The Ring Series</h5>
      <p class="card-text">This card has supporting text below as a natural lead-in to additional content.</p>
    </div>
    <div class="card-footer">
    <a type="button" class="btn btn-primary" href="#">Rent</a>
  ...
  <div class="card">
    <img class="card-img-top" src="n6.jpg" alt="Card image cap">
    <div class="card-body">
      <h5 class="card-title">Bright River</h5>
      <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This card has even longer content than the first to show that equal height action.</p>
    </div>
    <div class="card-footer">
    <a type="button" class="btn btn-primary" href="#">Rent</a>
    ...
    <footer class="bg-dark text-center text-white">
        ...
        <div class="container p-4">
            ...
            <section class="mb-4">
                ...
                <a class="btn btn-outline-light btn-floating m-1" href="#!" role="a"><i
