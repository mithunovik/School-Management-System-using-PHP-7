...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="mystery.css">
...
<body>
    ...
    <div class="col mb-4 mt-4">
        <h3 class="bg-dark text-center" style="color: white; font-family: Palatino Linotype;">Mystery</h3>
    </div>
    <div class="container">
        <div class="row">
            <div class="col">
                <div class="card-deck">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">It’s impossible to talk about mystery novels without immediately thinking of the legendary Agatha Christie. Amongst all of her works, none has a story quite as impeccably crafted as And Then There Were None</p>
                        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">The Big Sleep</h5>
                            <p class="card-text">Raymond Chandler’s idea of mystery strays from conventions — for him it’s less about the intricate plot and more about the atmosphere and characters.</p>
                        </div>
                        <div class="card-footer">
                            <a type="button" class="btn btn-primary" href="#">Rent</a>
                        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">This Wilkie Collins’s late Victorian novel is among the earliest psychological thrillers ever written. It follows what first appears to be a simple story of two star-crossed lovers — Walter Hartright and Laura Fairlie.</p>
                        </div>
                        <div class="card-footer">
                            <a type="button" class="btn btn-primary" href="#">Rent</a>
                        </div>
                ...
                <div class="card-deck mt-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">The Postman Always Rings Twice</h5>
                            <p class="card-text">The Postman Always Rings Twice is often lauded the most important crime book of the 20th century, and it's not hard to see why.</p>
                        </div>
                        <div class="card-footer">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">As it’s based on a real-life case that has already been solved, you might think all the mystery is taken out of Truman Capote’s In Cold Blood. Fortunately, that couldn’t be more wrong.</p>
                        </div>
                        <div class="card-footer">
                            <a type="button" class="btn btn-primary" href="#">Rent</a>
                        </div>
                    ...
                    <div class="card">
                        <img class="card-img-top" src="m6.jpg" alt="Card image cap">
                        <div class="card-body">
